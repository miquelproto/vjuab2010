...
#include "InputType/GamePad/GamePad.h"
#include "InputType/Keyboard/Keyboard.h"
#include "InputType/Mouse/Mouse.h"
...
bool CInputManager::Init (HWND hWnd, const Vect2i& screenRes, bool exclusiveModeinMouse)
{
  ...
  if(m_bIsOk)
  {
    m_pAction = new CActionToInput();
    m_pAction->Init();
    m_bIsOk = m_pAction->Load("./Data/actions.xml");
//    std::string myConfig;
//    m_pAction->GetActionConfig(myConfig, "SlowZoomViewerCam");
